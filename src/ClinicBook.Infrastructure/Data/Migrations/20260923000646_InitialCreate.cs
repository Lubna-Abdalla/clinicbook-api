        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Appointments_EndAfterStart", "[EndsAt] > [StartsAt]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_DoctorSchedules_EndAfterStart", "[EndTime] > [StartTime]");
                    table.CheckConstraint("CK_DoctorSchedules_SlotMinutes", "[SlotMinutes] BETWEEN 5 AND 120");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UX_Appointments_DoctorId_StartsAt_Active",
                table: "Appointments",
